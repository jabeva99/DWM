 ...
 */
static const char *fonts[]          = { "Noto Sans Mono:style=Bold:size=9","Font Awesome 5 Free Solid:size=10" ,"Font Awesome 5 Free Solid:size=10" };
static const char col_1[]  = "#222831"; /* background color of bar */
static const char col_2[]  = "#222831"; /* border color unfocused windows */
static const char col_3[]  = "#DDDDDD";
static const char col_4[]  = "#30475E"; /* border color focused windows and tags */
/* bar opacity
